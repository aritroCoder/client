...
from client.providers.openai.utils import extract_openai_models_from_catalog
...
class OpenAIProvider:
    def __init__(self):
        ...
        self.PUBLIC_MODELS_URL = "https://models.github.ai/catalog/models"
    ...
    async def fetch_public_provider_models(self) -> tuple[list[str], str]:
        if self.provider not in self.PUBLIC_MODELS_URL:
        ...
        if resp.status_code == 200:
            ...
            models = extract_openai_models_from_catalog(payload)
            if models:
                return models, "OK"
